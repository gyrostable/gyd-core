...
def test_get_pool_ids_multiple(bal_pool_registry, usdc, usdt):
...
def test_get_pool_ids_when_multiple(bal_pool_registry, dai, usdc, usdt):
    pool_id_1 = brownie.convert.to_bytes(1111, type_str="bytes32")
    bal_pool_registry.registerPoolId(dai, pool_id_1)

    pool_id_2 = brownie.convert.to_bytes(2222, type_str="bytes32")
    pool_id_3 = brownie.convert.to_bytes(3333, type_str="bytes32")

    bal_pool_registry.registerPoolId(usdt, pool_id_2)
    bal_pool_registry.registerPoolId(usdc, pool_id_3)
...
def test_get_pool_ids_when_multiple_per_token(bal_pool_registry, dai):
    pool_id_1 = brownie.convert.to_bytes(1111, type_str="bytes32")
    pool_id_2 = brownie.convert.to_bytes(2222, type_str="bytes32")
    pool_id_3 = brownie.convert.to_bytes(3333, type_str="bytes32")

    bal_pool_registry.registerPoolId(dai, pool_id_1)
    bal_pool_registry.registerPoolId(dai, pool_id_2)
    bal_pool_registry.registerPoolId(dai, pool_id_3)

    tx = bal_pool_registry.getPoolIds(dai)

    assert brownie.convert.to_bytes(tx[0], type_str="bytes32") == pool_id_1
    assert brownie.convert.to_bytes(tx[1], type_str="bytes32") == pool_id_2
    assert brownie.convert.to_bytes(tx[2], type_str="bytes32") == pool_id_3
