...
OUTFLOW_MEMORY: Decimal = Decimal(999948427878953216)
...
MAX_ALLOWED_VAULT_DEVIATION = scale("0.1")
...
BALANCER_POOL_IDS = {
    ...
    1: {
        "LUSD_CRVUSD": "0x317994cba902be6633de043a6bf05f4f08f4370200020000000000000000060b",
        "USDP_GUSD": "0x81e998523f02adf4679ff57fff8ca2b9d23a574700020000000000000000060a",
    },
}
...
SAFETY_BLOCKS_AUTOMATIC = 300  # ~1 hour on Mainnet
SAFETY_BLOCKS_GUARDIAN = 7200  # ~1 day on Mainnet
...
GYD_RECOVERY_WITHDRAWAL_WAIT_DURATION = 90 * SECONDS_PER_DAY
GYD_RECOVERY_MAX_WITHDRAWAL_WAIT_DURATION = 365 * SECONDS_PER_DAY
GYD_RECOVERY_MAX_TRIGGER_CR = scale("0.999")

# Config settings
GYD_RECOVERY_TRIGGER_CR = scale("0.95")
GYD_RECOVERY_TARGET_CR = scale("1.0")

STEWARDSHIP_INC_MIN_CR = int(scale("1.01"))
STEWARDSHIP_INC_DURATION = 365 * 24 * 60 * 60
STEWARDSHIP_INC_MAX_VIOLATIONS = 2


MAINNET_GOVERNANCE_ADDRESS = "0x78EcF97572c3890eD02221A611014F30219f6219"

REDEEM_DISCOUNT_RATIO = scale("0.9950")

VAULT_DUST_THRESHOLD = scale(100)

SHORT_FLOW_MEMORY = 999561094198769664
