...
interface IMotherBoard {
    ...
    /// @param inputTokenTuples the input tokens and associated amounts used to mint GYD
    ...
    /// @param outputTokenTuples the output tokens and associated amounts to return against GYD
